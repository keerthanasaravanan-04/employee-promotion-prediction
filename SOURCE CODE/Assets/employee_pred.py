...
with open(r'D:\Arun\new developement\new ongoing Development\EMPLOYEE PROMOTION PREDICTION\SOURCE CODE/Assets/pickle/model.pkl', 'rb') as handle:
...
with open(r'D:\Arun\new developement\new ongoing Development\EMPLOYEE PROMOTION PREDICTION\SOURCE CODE/Assets/pickle/scalar.pkl', 'rb') as handle:
